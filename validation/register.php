    ...
    <div class="main-left">
        ...
        <div class="main-right">
            <div class="login-right-top">
                    <span style=" color: rgba(0, 0, 0, 0.54);">Already have an account?<a href="login.php">Login</a></span>
            </div>
            <div class="form-login-right">
               <form method="post">
                    ...
                    <ul>
                        <li>Full Name</li>
                        <li><input required type="text" name="name"placeholder ="Eg: pham tuan anh"></li>
                        <li>Email</li>
                        ...
                        <li style="position: relative;">
                            <input required id="pass" name="pwd" type="password">
                            <box-icon style="position: absolute; right: 10px; top: 13px; cursor: pointer;"onclick="myfunction()" name='low-vision'></box-icon>
                        </li>
                        <li> <button type="submit">Register</button></li>
                    </ul>
                    <p style="cursor: pointer;">Can't receive SMS?</p>
               </form>
            </div>
            </div>
    </div>
